...
const Skills = () => {
    ...
    { 
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 128 128" className='w-12 h-12'>
          ...
          <radialGradient id="python-original-c" cx="1825.678" cy="444.45" r="26.743" gradientTransform="matrix(0 -.24 -1.055 0 532.979 557.576)" gradientUnits="userSpaceOnUse"><stop offset="0" stop-color="#B8B8B8" stop-opacity=".498"/><stop offset="1" stop-color="#7F7F7F" stop-opacity="0"/></radialGradient>
  ...
  const dbIcons = [
    ...
    },
    {
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 128 128" className='w-12 h-12'>
          <path d="M64.004 25.602c-17.067 0-27.73 8.53-32 25.597 6.398-8.531 13.867-11.73 22.398-9.597 4.871 1.214 8.352 4.746 12.207 8.66C72.883 56.629 80.145 64 96.004 64c17.066 0 27.73-8.531 32-25.602-6.399 8.536-13.867 11.735-22.399 9.602-4.87-1.215-8.347-4.746-12.207-8.66-6.27-6.367-13.53-13.738-29.394-13.738zM32.004 64c-17.066 0-27.73 8.531-32 25.602C6.402 81.066 13.87 77.867 22.402 80c4.871 1.215 8.352 4.746 12.207 8.66 6.274 6.367 13.536 13.738 29.395 13.738 17.066 0 27.73-8.53 32-25.597-6.399 8.531-13.867 11.73-22.399 9.597-4.87-1.214-8.347-4.746-12.207-8.66C55.128 71.371 47.868 64 32.004 64zm0 0" fill="#00618A"/>
        </svg>
      ),
      name: 'MySQL'
    }
  ...
  const toolIcons = [
    {
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="100" height="100" viewBox="0 0 48 48" className='w-12 h-12'>
          <linearGradient id="HjBUFHyNtcsDcBgnZBZ2Sa_0OQR1FYCuA9f_gr1" x1="37.8" x2="37.8" y1="43.37" y2="7.42" gradientUnits="userSpaceOnUse"><stop offset="0" stop-color="#29b6f6"></stop><stop offset="1" stop-color="#13b2f6"></stop></linearGradient>
          <path fill="url(#HjBUFHyNtcsDcBgnZBZ2Sa_0OQR1FYCuA9f_gr1)" d="M34.176,4.249c0.188,0.092,5.688,2.716,8.374,3.998C43.437,8.67,44,9.564,44,10.546v26.86	c0,0.981-0.559,1.874-1.443,2.299c-2.548,1.228-7.611,3.666-7.948,3.826C34.361,43.649,33.709,44,33.181,44	c-0.678,0-1.133-0.316-1.58-0.73L34,35.711V5.715l-2.254-1.135C32.228,4.109,32.896,4,33.291,4C33.653,4,33.948,4.138,34.176,4.249z"></path>
        </svg>
      ),
      name: 'VS Code'
    },
  ...
  return (
    <div className="min-h-screen relative overflow-hidden px-40">
      ...
      <div className="fixed inset-0 -z-10 overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-br from-gray-900 via-purple-900 to-violet-900 opacity-90"></div>
      ...
      <div className="container mx-auto px-4 py-16 relative z-10">
        ...
        <div className="space-y-20">
          ...
          <section className="relative animate-slide-up">
            <div className="absolute -left-8 top-1/2 transform -translate-y-1/2 w-16 h-16 bg-cyan-500 rounded-full filter blur-3xl opacity-20"></div>
          ...
          <section className="relative animate-slide-up" style={{ animationDelay: '0.1s' }}>
            <div className="absolute -right-8 top-1/2 transform -translate-y-1/2 w-16 h-16 bg-purple-500 rounded-full filter blur-3xl opacity-20"></div>
            <h2 className="text-3xl font-bold text-white mb-8 flex items-center">
              <span className="text-cyan-400 mr-2">&lt;</span>
              Frameworks & Libraries
              <span className="text-cyan-400 ml-2">&gt;</span>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-6">
              {frameworkIcons.map((framework) => (
                <SkillCard key={framework.name} icon={framework.icon} name={framework.name} />
              ))}
            </div>
          </section>
          ...
          <section className="relative animate-slide-up" style={{ animationDelay: '0.2s' }}>
            <div className="absolute -left-8 top-1/2 transform -translate-y-1/2 w-16 h-16 bg-emerald-500 rounded-full filter blur-3xl opacity-20"></div>
            <h2 className="text-3xl font-bold text-white mb-8 flex items-center">
              <span className="text-cyan-400 mr-2">&lt;</span>
              Databases
              <span className="text-cyan-400 ml-2">&gt;</span>
          ...
          {/* Tools */}
          <section className="relative animate-slide-up" style={{ animationDelay: '0.3s' }}>
            <div className="absolute -right-8 top-1/2 transform -translate-y-1/2 w-16 h-16 bg-amber-500 rounded-full filter blur-3xl opacity-20"></div>
            <h2 className="text-3xl font-bold text-white mb-8 flex items-center">
              <span className="text-cyan-400 mr-2">&lt;</span>
              Tools & Platforms
              <span className="text-cyan-400 ml-2">&gt;</span>
        ...
        {/* Footer CTA */}
        <section className="mt-32 text-center animate-fade-in" style={{ animationDelay: '0.4s' }}>
          <h2 className="text-2xl md:text-3xl font-bold text-white mb-6">
            Ready to build something amazing together?
          </h2>
          <button className="px-8 py-3 bg-cyan-600 hover:bg-cyan-700 text-white font-medium rounded-lg transition-all duration-300 transform hover:scale-105 shadow-lg shadow-cyan-500/20">
            Get In Touch
          </button>
        </section>
      </div>
